		...
		<div class="sidebar-left-content">
			...
			<div class="sidebar-left-nav-wrapper">
				...
				<div class="sidebar-chat">
					...
					<ul class="chat-menu">
						<li class="has-right-content"><a class="chat-room" href="<?php echo create_analytics_link( $main_url ); ?>"><img class="chat-icon" src="https://media1-production-mightynetworks.imgix.net/asset/14150824/geldhelden-favicon-2.png?ixlib=rails-0.3.0&auto=format&w=68&h=68&fit=crop&impolicy=Avatar&crop=faces"><?php _e('Geldhelden Community', 'geldhelden')?> </a></li>
					</ul>
